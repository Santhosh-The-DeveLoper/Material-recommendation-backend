...
@jwt_required()
def profile():
    user_email = get_jwt_identity()  # assuming this returns email
...
def update_material(id):
    ...
    # Remove _id if it's present in the incoming JSON
    if '_id' in data:
        del data['_id']
...
#     try:
#         data = request.json
#         required_fields = ["Material", "Durability", "Cost_Per_Unit", "Environmental_Suitability", 
#                            "Thermal_Insulation", "Availability", "Fire_Resistance", "Water_Resistance", 
#                            "Weight_Per_Unit (kg)"]
...
#         return jsonify({"message": "An error occurred while adding material"}), 500
...
#         except Exception as e:
#             logging.error(f"Invalid material ID: {id}")
...
#     except Exception as e:
#         logging.error(f"Error updating material with id {id}: {str(e)}")
#         return jsonify({"message": "An error occurred while updating material"}), 500
...
#         return jsonify({"message": "Material deleted successfully"})
#     except Exception as e:
#         logging.error(f"Error deleting material with id {id}: {str(e)}")
#         return jsonify({"message": "An error occurred while deleting material"}), 500
